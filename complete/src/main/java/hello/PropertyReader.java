...
public class PropertyReader {
	...
	static Map<String, String> getConfigDetail() {
		...
		try {
			...
			//input = new FileInputStream("c:/test_tally/tally_client_upload_config.properties"); //stock upload
			input = new FileInputStream("c:/test_tally/day_book_upload_config.properties"); //day book upload
